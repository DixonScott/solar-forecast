...
def main():
    ...
    system_df, pvoutput_df = pvoutput.save_outputs_to_csv(SYSTEM_IDS, mode="full", filepath="pvoutput.csv")
    weather_df = openmeteo.get_weather_for_locations(system_df, filepath="weather.csv")
